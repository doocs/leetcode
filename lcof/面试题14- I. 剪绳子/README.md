...
> **思考**
>
> 长度为 $n$ 的绳至少切一刀，穷举切点再对每段递归会重复计算同一长度。$n\le 58$，平方级填表可接受。
>
> 令 $f[i]$ 为长度 $i$ 的最大乘积，枚举最后一段 $j$，在“不再切 $i-j$”与“继续切”中取大。
...
> **思考**
>
> DP 枚举所有切法，但最优解几乎都由 $3$ 组成，余 $4$ 时改切 $2+2$。直接按 $n$ 对 $3$ 的余数分类，常数时间即可。
