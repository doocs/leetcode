...
> **思考**
>
> 每位可单独翻译，两位若在 $10\sim 25$ 也可合译，方案数满足类似斐波那契的递推，子问题重叠。
>
> 令 $dfs(i)$ 为从位置 $i$ 起的方案数：必加 $dfs(i+1)$，合法双位再加 $dfs(i+2)$。记忆化避免重复。
...
> **思考**
>
> 记忆化已给出相同转移，递归栈与哈希缓存仍占额外空间。从左到右滚动两个变量即可，转移与 $dfs(i+1)$、$dfs(i+2)$ 对应。
