...
> **思考**
>
> 每个工人只能做难度不超过其能力的工作，并取其中利润最大者。$n,m\le 10^4$，对每个工人扫描全部工作偏慢。
>
> 将工人与工作分别按能力、难度排序后双指针推进：能力单调不减，可维护当前可达的最大利润。每个工人 $O(1)$ 取该最大值。
...
> **思考**
>
> 双指针需要排序。难度上限为 $10^5$，也可用数组 $f[d]$ 记录难度恰为 $d$ 的最大利润，再前缀取最大值，得到「能力不超过 $i$ 时的最佳利润」。
>
