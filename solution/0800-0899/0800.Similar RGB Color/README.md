...
> **思考**
>
> 可简写颜色的每个通道只能取 $00,11,\ldots,ff$，即 $17$ 的倍数。相似度按三个通道平方差之和衡量，而通道之间互不影响，因此不必在 $16^3$ 种简写色上穷举。
>
> 对单个通道 $q$，将其表示为 $17y+z$ 后，余数 $z>8$ 时向最近的下一档进位，否则取当前档。三个通道各自取最近简写值再拼接，即得到题目所求颜色。
