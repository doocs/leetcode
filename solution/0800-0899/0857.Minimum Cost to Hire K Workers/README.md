...
> **思考**
>
> 工资须按同一比率发放且每人不少于期望，选 $k$ 人使总工资最小。比率由团中 $\textit{wage}/\textit{quality}$ 的最大值决定。$n\le 10^4$，枚举子集不可行。
>
> 按比率升序加入工人，当前比率已能覆盖团内所有人；用大根堆丢掉质量最大者，保持团大小为 $k$。每次恰好 $k$ 人时用「当前比率 $\times$ 质量之和」更新答案。
