...
> **思考**
>
> 骑士每步八向跳跃，最少步数即网格最短路。从 $(0,0)$ 做 BFS，首次到达 $(x,y)$ 的层数即答案。坐标范围有限，哈希记录访问避免重复入队。对称性虽可缩小象限，朴素 BFS 已能通过。
...
> **思考**
>
> 方法一从单侧扩展，距原点较远时队列更宽。双向 BFS 从起点与终点同时扩展，优先推进更短的一侧，两侧访问集合相交即为最短路，扩展结点数通常更少。
