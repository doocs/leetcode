...
> **思考**
>
> $n,m\le 1500$，一次购买会按因子整除关系赠送若干物品，之后剩余预算应按最便宜单价尽量多买。赠送关系只在「第一种购买」时触发，须与后续普通购买分开。
>
> 对第一种购买做 $0$-$1$ 背包：物品 $i$ 花费 $\textit{price}$，获得 $1+$ 能被其因子整除的种类数。再枚举该背包花费 $i$，加上 $\lfloor(\textit{budget}-i)/\textit{mn}\rfloor$ 份最便宜物品。
>
> 两段相加的最大值即为答案。
