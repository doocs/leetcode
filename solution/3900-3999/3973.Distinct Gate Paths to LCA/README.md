...
> **思考**
>
> 两人独立沿父边上升到 LCA，每步消耗当前颜色能用的一扇门，白门翻转颜色。询问多、树结构固定，不能每次模拟逐步走。
>
> 对每个结点预处理「持红/蓝卡向上能走多远、有多少种门序列」，或把门数视为组合数沿倍增表合并。询问时把 Alice、Bob 两段路径的方案相乘。
>
> 仓库中该题尚无实现代码，思考止于「树上倍增合并门组合」。
