...
> **思考**
>
> 每次可将一个字符沿字母环移动，总代价不超过 $k$，目标是字典序最小。若对剩余代价做全局搜索，状态空间随位置与 $k$ 膨胀。
>
> 字典序由左到右决定，贪心地把左侧字符尽量改小不会妨碍右侧。单个字符改到更小字母的最小环距离为 $\min(c_1-c_2,\,26-(c_1-c_2))$。
>
> 因此从左到右枚举每个位置，在小于当前字符的字母中找代价不超过剩余 $k$ 的最小者，扣去代价后继续。字母表大小为 $26$，枚举即可。
