...
> **思考**
>
> 判断句子是否包含全部 $26$ 个小写字母。线性扫描即可，关键是如何记录出现过的字母。
>
> 把字符放入集合，最后看大小是否为 $26$。集合去重后长度恰好对应字母种类。
...
> **思考**
>
> 方法一使用哈希集合，额外空间随字符集变化。字母只有 $26$ 个，可用整数 $mask$ 的第 $i$ 位标记字母 $i$ 是否出现，最后判断是否等于 $2^{26}-1$，空间降为常数。
