...
> **思考**
>
> 男孩与女孩的邀请关系构成二分图，每人至多配对一次，求最大配对数。若枚举全部匹配方案，状态数为指数级，$m,n\le 200$ 不可行。
>
> 这是经典的二分图最大匹配。匈牙利算法从每个未匹配的左部点寻找增广路：对右侧候选人做 DFS，若对方未匹配或能给其原配再找到新对象，则改写匹配。每个左部点至多尝试一次完整搜索，总时间可接受。
