...
> **思考**
>
> 每个供应商提供一组箱子，箱子只能装不大于其尺寸的包裹且每个箱子至多一个包裹，求最小浪费空间。包裹与箱子都可达 $10^5$，对每个箱子扫描包裹不可行。
>
> 包裹排序后，对每个供应商的箱子也排序。用二分把能装进当前箱子、尚未装箱的包裹一次性切出，累加 $b\times$ 个数。总空间减包裹总和即浪费，取各供应商的最小者。
