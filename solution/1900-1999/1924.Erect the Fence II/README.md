...
> **思考**
>
> 所求为覆盖全部点的最小圆。枚举直径或三点定圆可达 $O(n^3)$，$n\le 3000$ 偏紧。
>
> 最小覆盖圆由边界上两点（直径）或三点确定，Welzl 随机增量算法在期望线性时间内求出：若新点已在当前圆内则不变，否则该点必在新圆边界上，于是递归缩小点集。
>
> 实现时打乱点序并维护当前圆心与半径，误差按题面允许的 $10^{-5}$ 控制。
