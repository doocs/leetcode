...
> **思考**
>
> 给定 $2^n$ 个子集和，要还原原数组。和可能为负，先整体平移使最小者为 $0$，有序集合中下一个最小元必是数组中尚未确定的正元素。
>
> 每确定一个数，就从多重集中删去「旧子集和加上该数」的那些和。最后若平移量本身是某子集和，则把对应元素取负还原。
...
> **思考**
>
> 有序集合每次删除需对数开销。排序后最大两和之差即当前最大绝对值 $d$，再按计数把和拆成「不含 $d$」与「含 $d$」两半，符号由哪一半含 $0$ 决定。
