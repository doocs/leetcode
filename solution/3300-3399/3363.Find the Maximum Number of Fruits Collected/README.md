...
> **思考**
>
> 三人同时走 $n-1$ 步汇合。从 $(0,0)$ 出发者只能沿主对角线，另外两人分别被限制在对角线上侧与下侧，途中房间不重叠。
>
> 对角线的水果直接求和。上三角与下三角各自做 DP：$f[i][j]$ 由上方（或左方）相邻三格转移，并加上 $\textit{fruits}[i][j]$。
>
> 两人在到达终点前一格处停止，答案为对角线和加上 $f[n-2][n-1]$ 与 $f[n-1][n-2]$。
