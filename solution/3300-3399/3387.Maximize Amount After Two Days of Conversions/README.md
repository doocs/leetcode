...
> **思考**
>
> 两天使用两套汇率，可在货币图上任意兑换，求回到初始货币的最大数量。货币种类很少，从初始货币 DFS/BFS 即可得到当天每种货币的最大数量。
>
> 汇率双向：正边权为 $r$，反边权为 $1/r$。无环套利保证一次遍历就能得到从初始货币出发的最大倍率。
>
> 第一天得到 $d1[a]$，第二天要把 $a$ 换回初始货币，倍率为 $1/d2[a]$。对所有 $a$ 取 $d1[a]/d2[a]$ 的最大者。
