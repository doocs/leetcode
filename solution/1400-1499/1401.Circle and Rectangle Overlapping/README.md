...
> **思考**
>
> 枚举矩形内的格点或仅检查四个顶点，既可能漏掉边、内部与圆相交的情形，也与连续几何判定无关。坐标范围达 $10^4$，需要一次精确的几何判断。
>
> 圆与矩形相交，当且仅当矩形上距圆心最近的点落入圆内（含边界）。该最近点的横、纵坐标可分别在区间 $[x_1,x_2]$、$[y_1,y_2]$ 上独立夹取。
>
> 若圆心投影落在对应区间内，则该维距离为 $0$；否则取到较近端点的距离。两维平方和与 $radius^2$ 比较即可，避免开方。
