...
> **思考**
>
> 每天只能播种一枚种子，播种时间之和与顺序无关，开花日取决于「该种子播完时刻加上生长时间」的最大值。若先种生长短的，长生长者会更晚结束。
>
> 应尽早开始生长时间长的种子，按其 $\textit{growTime}$ 降序播种。前缀播种天数 $t$ 累加 $\textit{plantTime}$，该种子开花日为 $t+\textit{growTime}$，全程取最大。
>
> 按生长时间排序后一次扫描即可。
