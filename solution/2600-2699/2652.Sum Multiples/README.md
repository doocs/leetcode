...
> **思考**
>
> 求和 $[1,n]$ 中能被 $3$、$5$ 或 $7$ 整除的数。$n \le 1000$，枚举每个 $x$ 判断整除即可，实现最直接。
...
> **思考**
>
> 方法一线性扫过 $n$。能被 $x$ 整除的数构成等差数列，其和有闭式；容斥去掉重复倍数后可 $O(1)$ 求值。
>
> 即 $f(3)+f(5)+f(7)-f(15)-f(21)-f(35)+f(105)$。
...
> **思考**
>
> 与方法二同一容斥公式，仅用 Rust 重写闭式，算法与常数均不再变化。
