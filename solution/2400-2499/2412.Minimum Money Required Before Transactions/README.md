...
> **思考**
>
> $n \le 10^5$，枚举交易顺序不可行。亏钱交易的净亏损必须发生，总和 $s$ 固定；钱最少的时刻出现在某笔交易扣款之后、回款之前。
>
> 把每一笔轮流当作「现金最低点所在的那笔」：若该笔亏钱，此前已计入的亏损含 $a-b$，再加上本笔支出 $a$，即需 $s+b$；若该笔赚钱，此前仍需备齐全部亏损 $s$ 再支付 $a$。取所有情况的最大值。
