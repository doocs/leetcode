...
> **思考**
>
> 每个水果有买、不买、半价买三种选择，优惠券与金额有限。状态 $(i,j,k)$ 表示考虑到第 $i$ 个水果、剩余金额 $j$、剩余券 $k$，规模与 $n\times \textit{maxAmount}\times \textit{maxCoupons}$ 成正比，记忆化即可。
>
> 转移为跳过、全价购买（金额足够）、或用一张券半价购买。取三者最大美味度。
