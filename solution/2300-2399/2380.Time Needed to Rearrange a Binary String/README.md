...
> **思考**
>
> 每秒把所有 $01$ 同时变成 $10$。$n \le 1000$，最多 $n$ 轮，直接替换模拟可以通过。
>
> 循环执行 $replace(01,10)$ 直至不再出现，轮数即答案。
...
> **思考**
>
> 方法一最坏平方。实质上每个 $1$ 在向左穿过其左侧的 $0$。扫一遍统计已遇零的个数：遇到 $1$ 时，它的完成时刻是「比上一个 $1$ 多一秒」与「左侧零的个数」的较大者。
