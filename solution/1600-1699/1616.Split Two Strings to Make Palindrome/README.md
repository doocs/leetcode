...
> **思考**
>
> 分割点可以有 $n$ 种，$n$ 达 $10^5$，不能对每个分割点再花线性时间验回文。
>
> 若 $a$ 的前缀与 $b$ 的后缀尽量配对，剩余中间段必须本身是回文，且该中间段只能完全来自 $a$ 或完全来自 $b$。对称地交换 $a,b$ 再做一次。
>
> 双指针从两端向内，相等则收缩；停下后检查 $a[i..j]$ 或 $b[i..j]$ 是否回文，两方向任一成功即可。
