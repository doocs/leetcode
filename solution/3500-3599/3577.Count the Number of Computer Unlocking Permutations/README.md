...
> **思考**
>
> 编号 $0$ 已解锁，其它机器只能被复杂度严格更小且已解锁的机器打开。若存在 $i>0$ 使 $\textit{complexity}[i] \le \textit{complexity}[0]$，则该机永远无法解锁。
>
> 否则 $0$ 能打开其余所有机器，解锁顺序是 $\{1,\ldots,n-1\}$ 的任意排列，共 $(n-1)!$ 种。一边扫描一边累乘即可。
