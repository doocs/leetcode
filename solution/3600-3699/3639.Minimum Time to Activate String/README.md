...
> **思考**
>
> 按给定顺序把字符变成星号，当「被星号分割后，长度不少于 $k$ 的星号段」的某种激活条件首次满足时停止。时间 $t$ 越大星号越多，可行性单调，可以二分 $t$。
>
> 判定时将前 $t+1$ 个位置视为星号，统计这些星号作为子串端点能覆盖多少合法子串，或等价地用相邻星号间距计算贡献。
>
> 若贡献达到阈值则缩小时间。也可以按时间顺序插入星号并用有序集合维护间隔，增量更新贡献，首次达标即答案。
