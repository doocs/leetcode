...
> **思考**
>
> 数组是 $0..n-1$ 的排列，切块分别排序后应还原。能在 $i$ 切开，当且仅当前 $i+1$ 个数恰好是 $0..i$。
>
> 这等价于前缀最大值等于 $i$。一遍维护 $\textit{mx}$，相等则多一块。
...
> **思考**
>
> 方法一用到了「值等于下标」这一排列性质，有重复时失效。块最大值单调栈与 768 相同，不依赖值域。
>
> 新值小于栈顶则合并前面的块，最后栈长为块数。
