...
> **思考**
>
> 从 $(sx,sy)$ 只能做 $(x,x+y)$ 或 $(x+y,y)$，终点坐标可以很大，正向搜索分支无法收敛。逆运算是从较大维减去若干个较小维，即取模。
>
> 当两维都还大于起点且不相等时，把大的对小的取模，相当于一次走完能减的步。落到某一维已对齐后，另一维若能被该维整除地减到起点，则可达。
>
> 相等且等于起点则成功；两维都对不上则失败。取模避免逐次减法。
