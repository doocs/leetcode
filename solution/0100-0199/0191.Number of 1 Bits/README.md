...
> **思考**
>
> 统计二进制中 $1$ 的个数。逐位检查要看满 $32$ 位。$n\mathbin{\&}(n-1)$ 会清掉最低的 $1$，循环次数等于 $1$ 的个数，比固定 $32$ 次更省。
...
> **思考**
>
> 方法一用 $n\mathbin{\&}(n-1)$。$\textit{lowbit}=n\mathbin{\&}-n$ 同样取出最低的 $1$，减去它再循环，语义等价，便于和树状数组那套位运算对应。
