...
> **思考**
>
> 推动箱子的次数要最少，人自己走路不计。状态是人与箱的位置，$m,n \le 20$，状态数可接受。人走向箱子旁是零代价，推一步代价为 $1$，适合 0-1 BFS。
>
> 双端队列：人单独移动时 $d$ 不变，状态放入队头；人走进箱子格并沿同方向推出一格时 $d+1$，放入队尾。到达箱子在 $T$ 时的 $d$ 即最少推次。0-1 BFS 保证先处理零代价边。
