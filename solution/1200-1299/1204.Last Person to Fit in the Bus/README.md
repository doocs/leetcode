...
> **思考**
>
> 上车顺序由 $turn$ 唯一确定，能否上车只取决于到该人为止的体重前缀和是否不超过 $1000$。自连接把每个人与所有不晚于他的人配对，按人聚合后用 $HAVING$ 筛出仍能上车的人，再取 $turn$ 最大者即为最后上车的人。
...
> **思考**
>
> 自连接按人聚合需要 $O(n^2)$ 规模的配对。窗口函数按 $turn$ 求累计和，一次扫描即可得到每人上车后的总重量，再筛选并取最大累计和对应的姓名，语义与方法一相同而写法更直接。
