...
> **思考**
>
> 每次删去长度严格小于当前数组长度的子数组，Alice 最大化、Bob 最小化最终剩下的元素。$n \le 10^5$，博弈树无法展开。
>
> Alice 先手即可一次删掉中间整段，只留下两端之一，故答案至少是两端的较大者。
>
> 中间任一元素，只要不是最后剩下的，Bob 总能在后续轮次把它删掉。因此中间值无法被 Alice 保住。
>
