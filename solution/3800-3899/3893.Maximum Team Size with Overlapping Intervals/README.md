...
> **思考**
>
> 有效团队存在一人与其余所有人区间相交。求最大团队规模。$n \le 10^5$。
>
> 与 $i$ 相交的人构成以 $i$ 为「中心」的团队，规模即与 $i$ 重叠的人数（含自身）。
>
> 将全体左端、右端分别排序。对区间 $[l,r]$，结束早于 $l$ 的人数与开始晚于 $r$ 的人数都可用二分得到，其差为重叠人数。
>
> 对每个员工取最大即可。中心人必存在于最优团队中。
