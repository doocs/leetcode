...
> **思考**
>
> 激活沿相同 $x$ 或 $y$ 传播，可额外加一个新点，求能激活的最多点数。$n \le 10^5$。
>
> 同一 $x$ 或同一 $y$ 的点属于一个连通分量。并查集把坐标视为节点：点 $(x,y)$ 把 $x$ 与 $y$ 合并。
>
> 新点可连接两个原本不同的分量。应选点数最大的两个分量并额外计新点本身。
>
> 为避免 $x,y$ 撞号，将 $y$ 平移 $3 \times 10^9$ 后再参与并查。
