...
> **思考**
>
> 从小到大枚举并试除判定丑数，在第 $n$ 项较大时浪费大量非丑数。丑数只由已有丑数乘 $2,3,5$ 得到。
>
> 最小堆弹出当前最小丑数，再把其乘积入堆，哈希去重，弹出 $n$ 次即第 $n$ 个。
...
> **思考**
>
> 堆与去重集合占用额外空间且带对数。用三个指针指向下一个应乘 $2,3,5$ 的丑数，每次取三者最小写入 $dp$，相等的指针一并前进以免重复。
