...
> **思考**
>
> 美好子串要求每个出现的字母大小写都在。$n$ 很小，可枚举全部子串。
>
> 固定左端 $i$，向右扩张并用集合记录字符；集合内每个字母的大小写都在且更长时更新答案。同长时保留先出现的那段。
...
> **思考**
>
> 方法一对每个窗口扫描集合判断大小写，多一个 $C$ 因子。字母只有 $26$ 对，可用两个位掩码分别记小写与大写，窗口合法当且仅当两掩码相等。
