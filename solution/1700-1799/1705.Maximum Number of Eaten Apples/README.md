...
> **思考**
>
> 每天至多吃一个苹果，且必须吃尚未腐烂的。若随意选择，容易先吃掉保质期长的而浪费即将过期的，最终吃到的个数偏少。
>
> 在仍可食用的苹果中优先吃最早腐烂的，才能在每一天尽量不浪费。这对应按腐烂日期维护小根堆。
>
> 第 $i$ 天若有新苹果则把 $(\textit{腐烂日},\textit{数量})$ 入堆；弹出已过期的批次后，取堆顶吃一颗并写回剩余。持续到既无新货也无库存。
