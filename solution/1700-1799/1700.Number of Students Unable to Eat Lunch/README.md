...
> **思考**
>
> 若用队列模拟学生轮转，每次比较队首与栈顶，不匹配则把学生送到队尾，最坏情况下每人反复绕圈，实现冗长且依赖顺序。
>
> 注意到三明治顺序固定、学生可以任意调位：一旦栈顶种类在剩余学生中为零，后续三明治都无法被取走。因此只需统计两种喜好的人数，再按三明治顺序消耗计数。
>
> 当 $cnt[v]=0$ 时，剩余学生全部偏好另一种三明治，即 $cnt[v\oplus 1]$。线性扫完即可得到无法用餐的人数。
