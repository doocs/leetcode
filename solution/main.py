...
class LCSpider:
    ...
    def get_all_questions(self):
        ...
        for question in questions:
            ...
            frontend_question_id = str(question['stat']['frontend_question_id']).zfill(
                4
            )
            ...
            item = {
                ...
                'tags_cn': [
                    e['translatedName'] for e in topic_tags if e['translatedName']
                ]
                or [],
                'difficulty_en': question_detail.get('difficulty'),
                'difficulty_cn': self.difficulty_mapper.get(
                    question_detail.get('difficulty')
                ),
