...
# [4055. 统计影子数对 II](https://leetcode.cn/problems/count-shadow-pairs-ii)

[English Version](/solution/4000-4099/4055.Count%20Shadow%20Pairs%20II/README_EN.md)
...
<ul>
	...
	<li><strong>不存在</strong>下标 <code>k</code>，使得 <code>i &lt; k &lt; j</code> 且 <code>nums[i] &lt; nums[k] &lt; nums[j]</code>。</li>
</ul>
...
<p><strong>输入：</strong> <span class="example-io">nums = [3,1,4,2,5]</span></p>
...
<table style="border-collapse: collapse; text-align: center; width: 70%;">
	...
	<tbody>
		<tr>
			...
			<td>3</td>
			<td>4</td>
			<td><code>nums[1] = 1</code> 不严格位于 3 和 4 之间</td>
		</tr>
		<tr>
			<td>(1, 2)</td>
			<td>1</td>
		...
		<tr>
			...
			<td>1</td>
			<td>2</td>
			<td><code>nums[2] = 4</code> 不严格位于 1 和 2 之间</td>
		</tr>
		<tr>
			<td>(2, 4)</td>
			<td>4</td>
			<td>5</td>
			<td><code>nums[3] = 2</code> 不严格位于 4 和 5 之间</td>
		</tr>
		<tr>
			<td>(3, 4)</td>
			<td>2</td>
