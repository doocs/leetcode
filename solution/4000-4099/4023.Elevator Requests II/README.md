...
> **思考**
>
> 楼层编号达 $10^9$，但请求只有 $m\le 1500$ 个且互异，路径只需在这些楼层之间规划。电梯每秒必须移动一层，惩罚是各请求被访问时刻之和，访问次序决定全部完成时间。
>
> $m$ 已超出状压 TSP 的范围，然而点在数轴上，最优路线由若干段单向扫过构成。
>
> 将请求按楼层排序后，可用 $O(m^2)$ 的区间 DP 枚举下一段扫过的范围，避免在 $10^9$ 层上建图。
