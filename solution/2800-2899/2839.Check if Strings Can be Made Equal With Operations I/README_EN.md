...
> **Thinking**
>
> On a length-$4$ string, swaps only mix indices of the same parity, so even and odd positions are two independent alphabets. Equal frequency counts on both groups are necessary and sufficient.
