...
> **Thinking**
>
> A sortable array has at most one descent, and the second run must stay below $nums[0]$. After the first drop, scan the remainder; if it reaches the end, $n-i$ right shifts restore order.
