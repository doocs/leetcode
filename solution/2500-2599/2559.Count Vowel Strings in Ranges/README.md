...
> **思考**
>
> 若干区间查询：有多少单词首尾都是元音。每次现场判断区间内每个单词，$q$ 与 $n$ 达 $10^5$ 时过慢。
>
> 预处理出所有满足条件的下标，有序存放。一次查询变成“有多少下标落在 $[l,r]$”，两次二分之差即可。
...
> **思考**
>
> 方法一每次查询仍需对数开销。把是否为元音串写成 $0/1$ 前缀和后，区间计数就是 $s[r+1]-s[l]$，单次 $O(1)$。
