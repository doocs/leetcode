...
> **思考**
>
> 桥同时只能过一人，右岸等待优先，同岸则过桥时间之和更大者优先。箱子数为 $n$，工人状态随时间在两岸等待与装卸之间切换，直接按秒推进在时间范围 $10^9$ 下不可行。
>
> 按过桥时间和将工人排序，下标越大越慢，等待队列用大根堆取最慢者。装卸完成时间用小根堆，到期后回到对应等待堆。当前两岸都无人可过时，把时钟跳到下一完成时刻。右岸有人则让其先回左岸；否则派左岸的人带下一箱过去。最后一箱送回左岸的时刻即为答案。
