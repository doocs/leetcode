...
> **思考**
>
> 必须恰好买两块且花费不超过 $money$，并最大化剩余。枚举所有无序对在 $n\le 50$ 下可通过，但答案只取决于最便宜的两块。
>
> 将价格排序后取前两项之和 $cost$，若 $cost>money$ 则无法购买，否则剩余为 $money-cost$。
...
> **思考**
>
> 排序付出 $O(n\log n)$，而我们只需要两个最小值。一次扫描维护当前最小与次小，即可在线性时间内得到同样的 $cost$。
