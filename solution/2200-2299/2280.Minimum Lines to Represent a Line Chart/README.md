...
> **思考**
>
> 按日期连折线，共线的连续段只需一条直线。点数 $10^5$，日期互异。先按日期排序，再判断相邻两段斜率是否相同。用除法比斜率会有浮点误差，应改成交叉相乘。
>
> 维护上一段 $(\Delta x,\Delta y)$，若 $\Delta y\cdot\Delta x_1 \ne \Delta x\cdot\Delta y_1$ 则需要新的一条线。单个点贡献 $0$ 条。
