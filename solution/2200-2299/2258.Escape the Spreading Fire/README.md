...
> **思考**
>
> 人先停留 $t$ 分钟再出发，火每分钟向四向蔓延，问最大可行 $t$。网格至多约 $2\times 10^4$ 格。若 $t$ 可行，更短的停留也可行，答案单调，适合二分。
>
> 对候选 $t$，先让火蔓延 $t$ 分钟；若起点已着火则失败。再让人与火同步 BFS：人只走进尚未着火的空地，每走完一层火再蔓延一次。人先于火到达终点（或与火同时到达终点）则成功。上界取 $mn$，若连上界都成功则返回 $10^9$。
