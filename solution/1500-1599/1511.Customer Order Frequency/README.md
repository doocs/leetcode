...
> **思考**
>
> 要找出在 $2020$ 年六月与七月花费均不少于 $100$ 的顾客。订单、商品单价与顾客姓名分属三表，必须先对齐才能按人汇总金额。
>
> 将 $Orders$、$Product$、$Customers$ 等值连接，并限制年份为 $2020$。按顾客分组后，用条件求和分别累加六月、七月的 $quantity\times price$，在 $HAVING$ 中同时要求两月都不低于 $100$。
