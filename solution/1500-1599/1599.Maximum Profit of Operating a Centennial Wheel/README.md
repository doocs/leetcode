...
> **思考**
>
> 摩天轮每转一圈最多上 $4$ 人并扣除运转成本，求利润首次达到最大时的圈数。顾客分批到达，人数达 $10^5$，必须按圈模拟，不能跳过等待队列。
>
> 维护等待人数与累计利润：每圈并入新到达的人，上船 $\min(4,wait)$ 人，利润加上票价减去运转费。若当前利润严格更大则更新最佳圈数；队列与后续批次都空时停止。利润始终非正则返回 $-1$。
