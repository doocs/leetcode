...
<li>Each fraction (input and output) has format <code>¡Ànumerator/denominator</code>. If the first input fraction or the output is positive, then <code>'+'</code> will be omitted.</li>
