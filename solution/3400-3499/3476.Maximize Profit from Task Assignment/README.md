...
> **思考**
>
> 工人只能做技能相同的任务，每人至多一个，另可额外完成任意一个剩余任务。$n,m\le 10^5$，应按利润取最大。
>
> 先让每个工人拿走其技能下当前最大利润，再用一个「额外任务」从所有剩余里取最大。顺序上工人先取，避免把本该给工人的最大值留给额外名额。
>
> 哈希表把利润放进各技能的有序集合。工人弹最大；最后再扫一遍剩余堆顶，加上其中的全局最大。
