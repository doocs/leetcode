...
> **思考**
>
> 乘积等于最大公约数与最小公倍数之积，是对子数组的一个代数条件。$n\le 100$ 且元素 $\le 10$，枚举全体子数组并维护乘积、GCD、LCM 即可。
>
> 乘积增长很快，超过「全体 LCM 再乘最大值」这一上界后，再向右延伸不可能再满足等式，应当截断。
>
> 因此固定左端 $i$，向右累乘并更新 $g$、$l$，当 $p=g\cdot l$ 时用长度更新答案；当 $p$ 过大时跳出内层循环。
