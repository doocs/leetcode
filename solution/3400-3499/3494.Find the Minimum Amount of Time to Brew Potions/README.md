...
> **思考**
>
> 巫师流水线酿药水，药水必须连续传下去，下一名立刻开工。$n,m\le 5000$，状态是「上一瓶各巫师的完成时刻」。
>
> 当前瓶的开始时刻不能早于本人做完上一瓶，也不能早于上一名刚做完本瓶。正向扫一遍得到本瓶总完成时间。
>
> 由于中间不能等待，各巫师的完成时刻可由最后一名倒推：$f[i]=f[i+1]-\textit{skill}[i+1]\cdot x$。处理完所有瓶后 $f[n-1]$ 即答案。
