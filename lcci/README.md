...
|  [01.03](https://leetcode-cn.com/problems/string-to-url-lcci)  |  [URL化](/lcci/01.03.String%20to%20URL/README.md)  |  `字符串`  |  简单  |
...
|  [16.20](https://leetcode-cn.com/problems/t9-lcci)  |  [T9键盘](/lcci/16.20.T9/README.md)  |  `数组`  |  中等  |
...
|  [16.25](https://leetcode-cn.com/problems/lru-cache-lcci)  |  [LRU缓存](/lcci/16.25.LRU%20Cache/README.md)  |  `设计`  |  中等  |
...
|  [17.06](https://leetcode-cn.com/problems/number-of-2s-in-range-lcci)  |  [2出现的次数](/lcci/17.06.Number%20Of%202s%20In%20Range/README.md)  |  `数学`,`动态规划`  |  中等  |
...
|  [17.14](https://leetcode-cn.com/problems/smallest-k-lcci)  |  [最小K个数](/lcci/17.14.Smallest%20K/README.md)  |  `堆`,`排序`,`分治算法`  |  中等  |
